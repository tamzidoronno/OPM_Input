	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="clients.php">Old Clients</a></li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Old Clients</h2>
					</div>
						...
						<div class="row-fluid">
                        	<div class="x-box span12">
								...
								while($advocate_name = mysqli_fetch_row($name_query)){
									...
									$lawyer_id = $advocate_name[1];
									$client_sql = "SELECT a.*, b.name AS client_name, b.phone FROM `case_info` a LEFT JOIN `clients` b ON a.client_id=b.id WHERE a.lawyer_id='$lawyer_id' AND status=0 ORDER BY a.id DESC";
									
									$client_query = $lawyer->db->query($client_sql);
									echo '<div class="tab-pane '.$cls.'" id="lawyer_tab_'.$lawyer_id.'">';
									?>
                                    	<?php 
                                        ...
                                        <div class="box">
                                        	<div class="box-content">
                                            	<div class="fluid-btn-area">
                                                	<?php /*?><a class="btn btn-green" href="edit_client.php?id=<?php echo $client->id;?>">Edit</a><?php */?>
                                                    <a class="btn btn-red" onclick="remove_client('<?php echo $client->id;?>');">Delete</a>
                                                </div>
                                                <div class="row-fluid">
...
function remove_client(client_id){
	var con = confirm("Confirm delete this client?");
	if(con){
		location = 'action.php?task=delete_client&id='+client_id;
	}
}
</script>
