			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Add Client</h2>
					</div>
                    ...
                    if(isset($_POST['submit']))
					{
						...
						if(!empty($name) && !empty($phone) && !empty($recieved) && !empty($where) && !empty($recours))
						{
							...
							$client_data = $lawyer->addClient($dossier, $name, $phone, $adname, date("Y-m-d", strtotime($recieved)), $where, $recours, $aj, $convocation, $lastd, $payment, $question, $lawyer_id, date("Y-m-d H:i:s"), $lawyer_id, $rdv, $_FILES["attachment"]);
							if($client_data)
							{
					...
					?>
						<form action="" name="add-client" method="post" enctype="multipart/form-data" class="form-horizontal">
						  <fieldset>
							  ...
							  <div class="controls">
								<input name="dossier" type="text" rel="phone" class="input-xlarge" value="" required="required" />
							  </div>
							</div>
                          	<div class="control-group">
							  <label class="control-label" for="name"><span class="required">*</span> Client Name: </label>
							  <div class="controls">
								<input name="name" type="text" class="input-xlarge" value="" required="required" />
							  </div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="phone"><span class="required">*</span> Phone No: </label>
							  <div class="controls">
								<input name="phone" type="text" rel="phone" class="input-xlarge" value="" required="required" />
							  </div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="rdate"><span class="required">*</span> Receive Date: </label>
							  <div class="controls">
								<input name="recieved" type="text" class="input-xlarge datepicker" id="rdate" value="<?php echo date("m/d/Y"); ?>" required="required" />
							  </div>
							</div>
                            <div class="control-group">
                                <label class="control-label" for="where"><span class="required">*</span> Where: </label>
                                <div class="controls">
                                    <select name="where" data-placeholder="Where:" id="where" data-rel="chosen" required="required">
                                      <option value="1">OFPRA</option>
                                      <option value="2">CNDA</option>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="recours" data-placeholder="Recours" id="recours" data-rel="chosen" required="required" />
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input name="convocation" type="text" class="input-xlarge datepicker" id="convocation" value="">
							  </div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="lastd"> Document Last Date: </label>
							  <div class="controls">
								<input name="lastd" type="text" class="input-xlarge datepicker" id="lastd" value="">
							  </div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="payment"> Payment: </label>
							  <div class="controls">
								<input name="payment" type="text" class="input-xlarge" value="" />
							  </div>
							</div>
                            <?php if($userGroup==1){ ?>
							<div class="control-group">
								...
								?>
                                    ...
                                    ?>
                                        <option value="<?php echo $advocate_name[1]; ?>"><?php echo $advocate_name[2].' '.$advocate_name[3]; ?></option>
									<?php
                                    }
                                    ?>
                                  	</select>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<textarea name="question" id="question" class="input-xlarge"></textarea>
							  </div>
							</div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input name="rdv" type="text" class="input-xlarge datepicker" id="rdv" placeholder="Rdv" value="">
							  </div>
							</div>
