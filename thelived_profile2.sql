...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2018 at 09:40 AM
...
--
-- Database: `thelived_profile2`
--

-- --------------------------------------------------------

--
-- Table structure for table `educational_qualification_primary`
--
...
--
-- Dumping data for table `educational_qualification_primary`
--
...
--
-- Table structure for table `foreign_assignments_primary`
--
...
--
-- Dumping data for table `foreign_assignments_primary`
--
...
--
-- Table structure for table `military_courses_primary`
--
...
--
-- Dumping data for table `military_courses_primary`
--
...
--
-- Table structure for table `officer_skills_primary`
--
...
--
-- Dumping data for table `officer_skills_primary`
--
...
--
-- Table structure for table `profile_primary`
--
...
--
-- Dumping data for table `profile_primary`
--
...
--
-- Table structure for table `publications_articles_thesis_projects_primary`
--
...
--
-- Dumping data for table `publications_articles_thesis_projects_primary`
--
...
--
-- Table structure for table `specialized_certified_qualification_primary`
--
...
--
-- Dumping data for table `specialized_certified_qualification_primary`
--
...
--
-- Table structure for table `un_mission_primary`
--
...
--
-- Dumping data for table `un_mission_primary`
--
...
INSERT INTO `users` (`id`, `email`, `password`, `usergroup`, `status`, `created_date`, `modified`, `BA_No_Type`, `BA_No`, `Course_Type`, `Course`, `DoB`) VALUES
(2, 'neshmedia.test@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1, 1, '2015-03-02 13:40:50', '0000-00-00 00:00:00', 'BA', 9281, 'Spl', 44, '2018-12-14'),
(3, 'test@test.com', 'e10adc3949ba59abbe56e057f20f883e', 2, 1, '2015-03-02 16:23:55', '0000-00-00 00:00:00', '', 0, '', 0, '0000-00-00'),
(4, 'julien@test.com', 'e10adc3949ba59abbe56e057f20f883e', 2, 1, '2015-03-03 18:24:15', '0000-00-00 00:00:00', '', 0, '', 0, '0000-00-00'),
(6, 'test2@test.com', 'e10adc3949ba59abbe56e057f20f883e', 2, 1, '2015-03-09 17:48:21', '0000-00-00 00:00:00', '', 0, '', 0, '0000-00-00'),
(7, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, 1, '2018-10-25 19:59:33', '0000-00-00 00:00:00', '', 0, '', 0, '0000-00-00');
...
--
-- Indexes for table `educational_qualification_primary`
--
ALTER TABLE `educational_qualification_primary`
  ADD PRIMARY KEY (`id`),
  ADD KEY `educational_qualification_ibfk_1` (`BA_No_Type`,`BA_No`);

--
-- Indexes for table `foreign_assignments_primary`
--
ALTER TABLE `foreign_assignments_primary`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `military_courses_primary`
--
ALTER TABLE `military_courses_primary`
  ADD PRIMARY KEY (`id`),
  ADD KEY `military_courses_ibfk_1` (`BA_No_Type`,`BA_No`);

--
-- Indexes for table `officer_skills_primary`
--
ALTER TABLE `officer_skills_primary`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `profile_primary`
--
ALTER TABLE `profile_primary`
  ADD PRIMARY KEY (`BA_No_Type`,`BA_No`);

--
-- Indexes for table `publications_articles_thesis_projects_primary`
--
ALTER TABLE `publications_articles_thesis_projects_primary`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `specialized_certified_qualification_primary`
--
ALTER TABLE `specialized_certified_qualification_primary`
  ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `un_mission_primary`
--
ALTER TABLE `un_mission_primary`
  ADD PRIMARY KEY (`Id`);
...
--
-- AUTO_INCREMENT for table `educational_qualification_primary`
--
ALTER TABLE `educational_qualification_primary`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
-- AUTO_INCREMENT for table `foreign_assignments_primary`
--
ALTER TABLE `foreign_assignments_primary`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT for table `military_courses_primary`
--
ALTER TABLE `military_courses_primary`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `officer_skills_primary`
--
ALTER TABLE `officer_skills_primary`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
-- AUTO_INCREMENT for table `publications_articles_thesis_projects_primary`
--
ALTER TABLE `publications_articles_thesis_projects_primary`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `specialized_certified_qualification_primary`
--
ALTER TABLE `specialized_certified_qualification_primary`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `un_mission_primary`
--
ALTER TABLE `un_mission_primary`
...
--
-- Constraints for table `educational_qualification_primary`
--
ALTER TABLE `educational_qualification_primary`
  ADD CONSTRAINT `educational_qualification_primary_ibfk_1` FOREIGN KEY (`BA_No_Type`,`BA_No`) REFERENCES `profile_primary` (`BA_No_Type`, `BA_No`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `military_courses_primary`
--
ALTER TABLE `military_courses_primary`
  ADD CONSTRAINT `military_courses_primary_ibfk_1` FOREIGN KEY (`BA_No_Type`,`BA_No`) REFERENCES `profile_primary` (`BA_No_Type`, `BA_No`) ON DELETE CASCADE ON UPDATE CASCADE;
