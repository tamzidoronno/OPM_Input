...
if($query->num_rows){
	...
	while($result = $query->fetch_object()){
		$i++;
		echo '<tr><td><input type="text" name="Name_Of_The_Course[]" value="'.$result->Name_Of_The_Course.'" style="width:80px; font-size:12px;"></td> <td><input type="text" name="Location[]" value="'.$result->Location.'" style="width:80px; font-size:12px;"></td><td><input type="text" name="Duration[]" value="'.$result->Duration.'" style="width:80px; font-size:12px;"></td> <td><input type="text" name="Result_MT[]" value="'.$result->Result.'"></td> <td><input type="text" name="Year_MT[]" value="'.$result->Year.'"></td> <td><input type="text" name="Position[]" value="'.$result->Position.'"></td> <td><input type="text" name="Any_Achivement_MT[]" value="'.$result->Any_Achivements.'"></td> <td><input type="text" name="Any_Observation_Remarks[]" value="'.$result->Any_Observation_Remarks.'"></td> '.($i>1?'<i class="icon-remove removeRow"></i>':'').'</tr>';
	}
?>
<?php }else{ ?>
  <tr>
...
if($query->num_rows){
	...
	while($result = $query->fetch_object()){
		$i++;
		echo '<tr><td><input type="text" name="Mission_Name[]" value="'.$result->Mission_Name.'"></td> <td><input type="text" name="Country_UNM[]" value="'.$result->Country_UNM.'"></td> <td><input type="text" name="Year_UNM[]" value="'.$result->Year_UNM.'"></td> <td><input type="text" name="Details[]" value="'.$result->Details.'"></td>'.($i>1?'<i class="icon-remove removeRow"></i>':'').'</tr>';
	}
?>
<?php }else{ ?>
  <tr>
